  ...
  <div class="dept-manage">
    <div class="query-form">
      <el-form inline ref="queryForm" :model="queryForm">
        ...
        <el-form-item>
          <el-button type="primary" @click="getDeptList" size="small"
            >查询</el-button
          >
          <el-button @click="handleReset(queryForm)" size="small"
            >重置</el-button
          >
        </el-form-item>
      </el-form>
    </div>
    <div class="base-table dept-table">
      <div class="action">
        <el-button
          type="primary"
          @click="handleOpen"
          v-has:add="'dept-create'"
          size="small"
          >创建</el-button
        >
      </div>
      ...
      >
        ...
        <el-table-column label="操作" minWidth="120px" align="center">
