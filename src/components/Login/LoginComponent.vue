  ...
  <div class="shell">
    <div class="container b-container" ref="bContainer">
      <el-form
        ...
        :rules="rules"
      >
        <h3 class="form_title title">登入账号</h3>
        ...
        <span class="form_link">忘记密码？请联系管理员！</span>
        <button @click="getButtons(signin)" class="form_button button submit">
          SIGN IN
        </button>
      </el-form>
    </div>
    ...
    <div class="switch" id="switch-cnt" ref="switchCtn">
      ...
      <div class="switch_container" ref="switchC1">
        <h3 class="title" style="letter-spacing: 0">
          Welcome Attendance Manage！
        </h3>
        <p></p>
      </div>
    </div>
